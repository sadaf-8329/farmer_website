...
<?php }?>
                    ...
                    <h3 class="text-white">Add Products Here!</h3>


                  </div>
                <br>
 <form action="<?php echo site_url('farmer_controller/addproducts'); ?>" class="user"  method="post" enctype="multipart/form-data">
                <?php
foreach ($this->farmer_model->get_data() as $row) {
    ?>
...
?>
          ...
          <!--<a href="<?php echo site_url('farmer_controller/seepro'); ?>" class="btn btn-primary">Save</a> -->
                   <a href="<?php echo site_url('farmer_controller/editpro'); ?>" class="btn btn-danger">Cancel</a>
                   </div>
