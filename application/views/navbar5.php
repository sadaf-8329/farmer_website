...
<!--  <li class="nav-item">
 ...
 <li class="nav-item">
   ...
   <li class="nav-item">
    <a class="nav-link text-white" href="<?php echo site_url('farmer_controller/logout'); ?>" data-toggle="modal" data-target="#myModal"><i class="fas fa-power-off prefix text-white"></i> Logout</a>
...
<div class="modal" id="myModal">
  <div class="modal-dialog">
   ...
   <!--  <input type="submit" name="logoutbtn" value="Logout" class="text-white"> -->
      ...
      <a class="btn btn-success" href="<?php echo site_url('farmer_controller/logout'); ?>">Logout</a>
