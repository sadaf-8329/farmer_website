...
<!--  <li class="nav-item">
 ...
 <li class="nav-item">
               <a class="nav-link text-white" href="#"><i class="fas fa-user prefix text-white"></i> <?php echo $this->session->userdata('name'); ?></a>
</li>

 <li class="nav-item">
               <a class="nav-link text-white" href="<?php echo site_url('enquiry/page'); ?>"><i class="fas fa-envelope prefix text-white"></i> Enquiry Details</a>
</li>


   <li class="nav-item">
    <a class="nav-link text-white" href="<?php echo site_url('admin_controller/logout1'); ?>" data-toggle="modal" data-target="#myModal"><i class="fas fa-power-off prefix text-white"></i> Logout</a>
...
<div class="modal" id="myModal">
  <div class="modal-dialog">
   ...
   <!--  <input type="submit" name="logoutbtn" value="Logout" class="text-white"> -->





      <a class="btn btn-success" href="<?php echo site_url('admin_controller/logout1'); ?>">Logout</a>
